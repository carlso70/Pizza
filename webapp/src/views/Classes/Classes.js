...
class Classes extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            newClassName: "",
            newClassDescription: "",
            classroom: <h4>Select a class</h4>
        };
    ...
    setClassroom(title) {
        this.setState({
            classroom: <Classroom classTitle={title} />
        });
    }
            ...
            return (
                    ...
                    <ListGroup>
                    {
                        this.state.classes.map((listValue) => {
                            return <ListGroupItem onClick={() => this.setClassroom(listValue.title)}>{listValue.title}</ListGroupItem>
                        })
                    }
                    </ListGroup>
                    </Panel>
                    <Panel header={<h4>Selected Class</h4>}>
